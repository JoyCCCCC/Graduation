...
public class SystemEvaluationController {
    ...
    public void insertSystem(int S_evaluate_id,String Course_name,String Stu_name,int Count,String S_Content,int Course_id,int Stu_id){
        System.out.println(systemEvaluationMapper.insertSystem(S_evaluate_id,Course_name,Stu_name,Count,S_Content,Course_id,Stu_id));
    }
    @ApiOperation(value="删除教师")
    @RequestMapping(value = "//deleteSystem")
    public void deleteSystem(int S_evaluate_id){
        System.out.println(systemEvaluationMapper.deleteSystem(S_evaluate_id));
    }
}
