  ...
  <div>
    ...
    <el-card class="mb-18">
        ...
        <div class="add-cont-part pt-18 plr-18">
          ...
          >
            ...
            <el-form-item label="开票时间">
              <el-date-picker v-model="item.time" type="date" value-format="yyyy-MM-dd" placeholder="请输入开票时间" />
            </el-form-item>
            <el-form-item>
      ...
      <el-form :inline="true" size="small" class="form-text-inline text-center">
        ...
        <el-form-item label="本次开不含税金额：">
          <span class="text">111</span>
        </el-form-item>
        <el-form-item label="累计已开票金额：">
          <span class="text">111</span>
        </el-form-item>
        <el-form-item label="累计已开票不含税金额:">
          <span class="text">111</span>
        </el-form-item>
      ...
      <div class="foot-button text-center">
        <el-button type="primary" size="small" @click="$router.push('/contract-manage/pending-bill')">保存</el-button>
        <el-button size="small" @click="$router.push('/contract-manage/pending-bill')">取消</el-button>
      </div>
    </el-card>
  </div>
</template>
